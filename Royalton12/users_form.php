...
<form action="pdf.php?id=<?php echo urlencode($row['id_form'])?>" id="form" method="post"> 
...
<br>
<div>
                                                                            <span class="d-block pb-2">Digital Sign (disabled)</span>
                                                                                    <div class="signature mb-2" style="width: 50%; height: 100px;">
                                                                                        <!-- <canvas  style="border: 1px dashed black; width: 200px; height: 100px;"></canvas> -->
                                                                                        <div style="border: 1px dashed black; width: 200px; height: 100px;"></div>
                                                                                    </div>
...
<span class="d-block pb-2">Firma digital aqui</span>
    ...
    <l                                                                </div>-->
<!--<label>Firma</label>
    <input type="radio" name="firma" value="Firma" >-->
